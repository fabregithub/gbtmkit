...
<p class="caption">Fitted group trajectories</p>
</div>
...
<p class="caption">Fitted continuous group trajectories</p>
</div>
...
Most of the walkthrough above used the default native engine, switching to
`trajeR` (the multi-start demo) and `flexmix` (the covariate demo) only where a
section needed to show that engine's behaviour. Estimation is pluggable:
