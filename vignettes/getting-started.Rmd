...
This stage only applies to engines that offer several optimisers -- of the
four backends, only `trajeR` does (`"L"`, `"EM"`, `"EMIRLS"`); the one with
the lowest BIC is selected. Single-optimiser engines (including the default
native engine) skip this stage automatically.
