...
to interchangeable backends -- `trajeR` (the default), `flexmix`, and `lcmm` --
...
[Choosing an engine](#choosing-an-engine) section at the end compares the
backends and shows how to switch.
