...
- **Shoji F. Nakayama**. Author, maintainer.
...
Trajectory Modeling*. R package version 0.0.0.9000,
<https://github.com/fabregithub/gbtmkit>.

    @Manual{,
      title = {gbtmkit: Engine-Agnostic Pipeline for Group-Based Trajectory Modeling},
